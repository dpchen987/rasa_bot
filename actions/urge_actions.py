...
class ActionUrge(Action):
    ...
    def __init__(self):
        self.url = deploy_config.WEB_URL+'wdgj-chatbot-server/intention/utter/queryUrgeTransfer'
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        if deploy_config.intent_map.get(slot_core_intent) is not None and deploy_config.intent_map.get(slot_core_intent) != 'urge':
