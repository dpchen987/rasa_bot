...
perfunctory_attitude_pat = re.compile(r"你.{,4}[什么就这啥].{,2}态度|有气无力|没睡[觉醒]|你.{,5}态度.{,3}[能可].{,3}好|[能可].{,5}态度.{,3}好|[你我].{,3}是.{,3}客服|不是我.{,3}你.{,3}解决|是你.{,13}不是我|你.{,3}复读机|你.{,3}机器人|给.{,10}干[啥什么嘛]+[$，]|"
