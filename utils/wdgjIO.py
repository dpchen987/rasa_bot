...
guide_upgrade_skip_pat = re.compile(r"不是|没有|邮政的|(?:我|这边).{,3}[给帮][你您]|[给帮][你您].{,3}(?:升级|投诉)|不需?[用要]|没必要|[别不].{,2}打|已经|工单|[单尾]号|核实|[接收]到|上报|尾数|要求|尽快|处理|123456|也会|一样|[前昨].?天|的话|回复|被.{,2}举报|被.{,2}投诉|您的.{,5}投诉|是[吗么嘛吧]|"
