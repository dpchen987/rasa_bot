...
incrt_lang_pat = re.compile(r"[你他][妈]|神经|变态|[傻呆妈][逼bB蛋]|妈.{,4}[逼的]|[有]毛?病|我[操靠草日]|[操日].{,3}[你他妈]|[滚聋傻]|贱[人货骨]|[犯太真]贱|什么玩意|人渣|不要脸|狗[日屁东]|是[狗猪]|[狗猪]一样|[笨蠢]猪|[笨蠢]的.{,3}猪|算什么东西|闭嘴|没.{,3}脑子|智障|废话|更年期|你大爷|[瞎胡]扯|"
                            r"无[聊语]|恶心|[气去]死|倒霉|md|没.{,3}[眼耳脑]|[眼耳脑].{,3}[坏病问题]|听[力觉].{,3}有问题|[你眼].{,2}瞎|[眼耳脑].{,3}干.{,3}用|嘴.{,3}干净|[真太好]烦|活该|正常.{,3}[都可能].{,4}理解|[说讲]人话|问候.{,3}全家|大爷.{,7}资格")
incrt_lang_skip_pat = re.compile(r"狗[肉粮]|[热遛狗]狗|宠物狗|眼泪|电脑|操[作控纵心练办场盘]|[假节]日|[你我他]们|您|猪猪|倒霉|[这有那]个贱|先生|没有|没.{,3}毛病|[我爸老姑妈]妈|无[语聊]|烦|^他妈$|气死(?!你)|(?<![你我去真滚日操干说])[他你]妈(?![的滚了个傻逼还死鸡毛])|(?<![你我他])妈(?![的滚了个傻逼还死鸡毛])|"
                                 r"我.?傻|商家|我[是有毛]+病|靠[靠一下你我他近天山背垫边]")
guide_upgrade_pat = re.compile(r"(?:邮[管政局]|123[104]5|消.{,5}协|市民热线|监管部门|媒体|第三方).{,5}(?:反馈|投诉|举报)|(?:反馈|投诉|举报).{,3}到.{,3}(?:邮[管政局]|123[104]5|消.{,5}协|市民热线|监管部门|媒体|第三方)|(?:联系|打).{,3}(?:123[104]5|消.{,5}协|市民热线|监管部门|媒体|第三方)|"
                               r"(?:媒体|新闻).{,3}(?:报道|曝光)|曝光.{,3}到.{,3}(?:媒体|新闻)|(?:其他|别的).{,2}(?:渠道|地方|方式).{,3}投诉|升级.{,3}投诉|(?:不[然行]|直接|就|可以).{,3}(?:123[104]5|消.{,5}协|监管部门)")
guide_upgrade_skip_pat = re.compile(r"不是|没有|邮[管局政]+的|(?:我|这边).{,3}[给帮][你您]|[给帮][你您].{,3}(?:升级|投诉)|不需?[用要]|没必要|[别不].{,2}打|已经|工单|[单尾]号|核实|[接收]到|上报|尾数|要求|尽快|处理|123456|也会|一样|[前昨].?天|的话|回复|被.{,2}举报|被.{,2}投诉|您的.{,5}投诉|是[吗么嘛吧]|"
                                    r"[有又].{,7}(?:反馈|投诉|邮[管局政]|12305|看[到见您])|[有又][在到]|(?:反馈|投诉).{,5}[吗么]|在.{,2}邮[管局政]|(?:反馈|投诉)[过了的]|因为|邮政.{,3}(?:单[号子]|快[递件])|协商|他|发件人|耐心|等待|签收|异常|查询|之前|[看收]到|储蓄|邮储|银行|(?:我们|这[边里]).{,7}圆通|商家|平台|转邮政")
customer_be_threatened_pat = re.compile(r"恐吓.{,3}我|威胁.{,3}我|[搞弄]死?我|[要叫让说].{,3}晚上.{,3}[不别].{,3}[出门]|[揍打骂抱摸]我|自杀|强[奸暴]|偷窥|调戏")
customer_be_threatened_skip_pat = re.compile(r"打我.{,3}(?:手机|电话|号码|[这那哪]个)|商家")
upgrade_intention_pat = re.compile(r"邮.{,3}[政局].{,3}总局|国家邮.{,3}[政局]|123[104]5|315|消.{,5}协|市民热线|监管部门|媒体|报道|举报|曝光|第三方.{,5}投诉|(?:其他|别的).{,2}(?:渠道|地方|方式).{,3}投诉|"
                                   r"新闻|记者|报社|栏目组|微博|朋友圈|起诉|升级|管理部门|报[案警]|法院|邮[管政局].{,5}(?:反馈|投诉|举报)|(?:反馈|投诉|举报|联系|打|不[然行]|直接).{,3}邮[管政局]")
upgrade_intention_skip_pat = re.compile(r"储蓄|邮储|银行|[转从发]邮[政局]|商家|是邮[政局]的|邮[政局].{,2}[件快递]|报警人|车险|[他你]报[警案]|自助报案")
customer_praise_pat = re.compile(r"(?:我|怎么|方[式法]|途径)[^不]{,3}表扬你|[给你].{,3}(?:好评|赞)|(?:我|怎么|方[式法]|途径)[^不]{,3}好评|表扬.{,2}你")
customer_praise_skip_pat = re.compile(r"要好评|是[吧吗么]|不[可能给会想]|可能|玩笑|什么|[啥毛屁]|差评|没|[叫让]我|你们|他|快递|业务员|客服")
response_untimely_pat = re.compile(r"[不别].{,3}静音|在听?[吗么嘛吧]$|有没有.{,3}听|能不能.{,3}听|听.{,5}了[吗没么嘛]|[能有]听.{,6}[吧么嘛吗]|问你话|跟你[说讲]话呢?$|人.{,3}呢|[说讲].{,2}话.{,2}[呀啊吗么嘛]|[说讲][呀啊吗么嘛]|[怎什么啥咋].{,3}不.{,2}[说讲话答]|"
                                   r"回[答][呀啊我]|请回[答]|回[答]一?下|[说讲回][话答]$|客服.{,3}[呢在哪]|[有没].{,2}人.{,3}[吗么嘛不吧]|在干[嘛啥什]|在不在[吗么啊呀呢嘛你？]?$")
response_untimely_skip_pat = re.compile(r"听.{,3}[到见清楚]|你们|您|他|谁|快递|业务员|客服|[网站签收派送转]|登记|反馈|其他|上报|没回|怎么[说办]|之内|一会|刚才|我回|给我|因为|所以|如果|但|是[吗么]?$|然后|那|任何|动静|客户|记得|[yt7]|这[些个里]|[明昨今]天|现在|时候|马上|回复|大家|几个|我能")
interrupt_speech_pat = re.compile(r"(?:不要|别).{,2}[说讲插抢].{,2}[话嘴]|(?:不要|别).{,2}打断|[插抢]我.{,2}话|你.{,2}[插抢]话|我.{,2}没.{,2}[说讲]完|能.{,2}[让听]我.{,2}[说讲].{,2}[吗么嘛]|[让听]我[^再]{,3}[说讲]|[你我]说还是.{,2}[你我]说|"
                                  r"能不能.{,5}[听]|我.{,5}[说讲]完.{,2}了[吗么嘛]|闭嘴")
interrupt_speech_skip_pat = re.compile(r"听.{,3}[到见清楚]|你们|他|快递|业务员|客服|[网站签收派送转]|登记|反馈|其他|上报|给我|咋说|电话")
understand_insufficiently_pat = re.compile(r"你.{,3}新[人来]|你.{,5}(?:理解|能力).{,5}问题|你.{,3}[先没不].{,3}(?:理解|懂|明白|[搞弄]清|清楚|明确)|你.{,2}(?:能|可以).{,3}[说讲].{,3}(?:明白|清楚)[一点些吗么嘛？]+$|我.{,3}[没不].{,3}(?:理解|懂|明白|[搞弄]清|清楚|明确).{,3}你.{,3}[说讲答意思]|你.{,3}到底.{,3}(?:理解?[不没]理解|清楚?不清楚|知道?不知道|懂[不没]懂)|"
...
perfunctory_attitude_pat = re.compile(r"你.{,4}[什么就这啥].{,2}态度|有气无力|没睡[觉醒]|你.{,5}态度.{,3}[能可].{,3}好|[能可].{,5}态度.{,3}好|[你我].{,3}是.{,3}客服|不是我.{,3}你.{,3}解决|是你.{,13}不是我|你.{,3}复读机|你.{,3}机器人|给.{,10}干[啥什么嘛啊]+$|给.{,10}干[啥什么嘛啊]+，|"
                                      r"[你少别].{,7}敷衍|[你少别].{,7}抬杠|你.{,7}过分|你.{,7}消极|开.{,5}玩笑|你.{,3}是.{,3}客服|你.{,5}态度.{,3}[不好恶劣太差垃圾有点些问题]|好好[说讲]话|[能会].{,5}[说讲]人?话[吗么呢嘛？]*$|[说讲]人?话.{,5}[能会][不吗么嘛]")
perfunctory_attitude_skip_pat = re.compile(r"听.{,3}[到见清楚]|你们|他|快递|业务员|客服|[网站签收派送转]|登记|反馈|其他|上报|不好意思|我态度|[我]开玩|我不能|态度[^能不哪要差，]{,2}(?:可以|不错|行)")
# 无用输入list
        ...
        async def receive(request: Request) -> HTTPResponse:
            ...
            try:
                ...
                if collector.messages and collector.messages[-1].get('last_message'):
                    ...
                    if last_message['intent_name'] == 'customer_praise' and (not customer_praise_pat.search(last_message['text']) or customer_praise_skip_pat.search(last_message['text'])):
