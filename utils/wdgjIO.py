...
incrt_lang_pat = re.compile(r"[你他][妈]|神经|变态|[傻呆妈][逼bB蛋]|妈.{,4}[逼的]|[有]毛?病|我[操靠草日]|[操日].{,3}[你他妈]|[滚瞎聋傻]|贱[人货骨]|[犯太真]贱|什么玩意|人渣|不要脸|狗[日屁东]|是[狗猪]|[狗猪]一样|[笨蠢]猪|[笨蠢]的.{,3}猪|算什么东西|闭嘴|没.{,3}脑子|智障|废话|更年期|你大爷|[瞎胡]扯|"
                            r"无[聊语]|恶心|[气去]死|倒霉|md|没.{,3}[眼耳脑]|[眼耳脑].{,3}[坏病问题]|听[力觉].{,3}有问题|[眼耳脑].{,3}干.{,3}用|嘴.{,3}干净|[真太好]烦|活该|正常.{,3}[都可能].{,4}理解|[说讲]人话|问候.{,3}全家|大爷.{,7}资格")
incrt_lang_skip_pat = re.compile(r"狗[肉粮]|[热遛狗]狗|宠物狗|眼泪|电脑|操[作控纵心练办场盘]|[假节]日|[你我他]们|您|猪猪|倒霉|[这有那]个贱|先生|没有|没.{,3}毛病|[我妈]妈|无[语聊]|烦|^他妈$|气死(?!你)|(?<![你我去真滚日操干说])[他你]妈(?![的滚了个傻逼还死鸡毛])|(?<![你我他])妈(?![的滚了个傻逼还死鸡毛])|我.?傻|商家")
...
response_untimely_skip_pat = re.compile(r"听.{,3}[到见清楚]|你们|您|他|谁|快递|业务员|客服|[网站签收派送转]|登记|反馈|其他|上报|没回|怎么[说办]|之内|一会|刚才|我回|给我|因为|所以|如果|但|是[吗么]?$|然后|那|任何|动静|客户|记得|[yt7]|这[些个里]|[明昨今]天|现在|时候|马上|回复|大家|几个|我能|跟你说")
