...
incrt_lang_pat = re.compile(r"[你他][妈]|神经|变态|[傻呆妈][逼bB蛋]|妈.{,4}[逼的]|[有毛]病|我[操靠草日]|[操日].{,3}[你他妈]|[滚贱瞎聋傻]|什么玩意|人渣|不要脸|狗[日屁东]|是[狗猪]|[狗猪]一样|[笨蠢]猪|[笨蠢]的.{,3}猪|算什么东西|闭嘴|没.{,3}脑子|智障|废话|更年期|你大爷|[瞎胡]扯|"
                            r"无[聊语]|恶心|[气去]死|倒霉|md|没.{,3}[眼耳脑]|[眼耳脑].{,3}[坏病问题]|听[力觉].{,3}有问题|[眼耳脑].{,3}干.{,3}用|嘴.{,3}干净|[真太好]烦|活该|正常.{,3}[都可能].{,4}理解|[说讲]人话|问候.{,3}全家|大爷.{,7}资格")
incrt_lang_skip_pat = re.compile(r"狗[肉粮]|[热遛狗]狗|宠物狗|眼泪|电脑|操作|[假节]日|[你我他]们|您|猪猪|倒霉|[这有那]个贱|先生|没有|没.{,3}毛病|[我妈]妈|无[语聊]|烦|^他妈$|气死(?!你)|(?<![你我去真滚日操干说])[他你]妈(?![的滚了个傻逼还死鸡毛])|(?<![你我他])妈(?![的滚了个傻逼还死鸡毛])")
...
guide_upgrade_skip_pat = re.compile(r"不是|没有|邮[管局政]+的|(?:我|这边).{,3}[给帮][你您]|[给帮][你您].{,3}(?:升级|投诉)|不需?[用要]|没必要|[别不].{,2}打|已经|工单|[单尾]号|核实|[接收]到|上报|尾数|要求|尽快|处理|123456|也会|一样|[前昨].?天|的话|回复|被.{,2}举报|被.{,2}投诉|您的.{,5}投诉|是[吗么嘛吧]|"
                                    r"[有又].{,7}(?:反馈|投诉|邮[管局政]|12305|看[到见])|[有又][在到]|(?:反馈|投诉).{,5}[吗么]|在.{,2}邮[管局政]|(?:反馈|投诉)[过了的]|因为|邮政.{,3}(?:单[号子]|快[递件])|协商|他|发件人|耐心|等待|签收|异常|查询|之前|[看收]到|储蓄|邮储|银行|(?:我们|这[边里]).{,7}圆通|商家|平台|转邮政")
...
upgrade_intention_skip_pat = re.compile(r"储蓄|邮储|银行|[转从发]邮[政局]|商家|是邮[政局]的|邮[政局].{,2}[件快递]")
...
response_untimely_skip_pat = re.compile(r"听.{,3}[到见清楚]|你们|您|他|谁|快递|业务员|客服|[网站签收派送转]|登记|反馈|其他|上报|没回|怎么[说办]|之内|一会|刚才|我回|给我|因为|是[吗么]?$|然后|那|任何|动静|客户|记得|[yt7]|这些|明天|时候|马上|回复")
...
perfunctory_attitude_skip_pat = re.compile(r"听.{,3}[到见清楚]|你们|他|快递|业务员|客服|[网站签收派送转]|登记|反馈|其他|上报|不好意思|我态度|[我]开玩")
# 无用输入list
