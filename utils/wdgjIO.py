...
understand_insufficiently_pat = re.compile(r"你.{,3}新[人来]|你.{,5}(?:理解|能力).{,5}问题|你.{,3}[没不].{,3}(?:理解|懂|明白|[搞弄]清|清楚|明确)|我.{,3}[没不].{,3}(?:理解|懂|明白|[搞弄]清|清楚|明确).{,3}你|(?:理解|懂|明白|[搞弄]清|清楚|知道).{,5}[吗么嘛不吧]|理解?[不没]理解|清楚?不清楚|知道?不知道|懂[不没]懂|"
                                           r"你.{,3}(?:回答|[说讲]).{,3}不是我|我.{,3}不.{,3}[说讲]过|[说讲告你].{,3}[多几十百].{,3}遍|你.{,3}培训.{,3}[了没吗吧]|你.{,3}[不没].{,3}培训|你.{,3}这.{,3}水平|你.{,3}登记.{,3}[没吗么嘛吧]|你觉得呢|答非所问|都说了|你.{,3}干什么.{,3}的|干什么.{,3}的你|[说讲]人话")
