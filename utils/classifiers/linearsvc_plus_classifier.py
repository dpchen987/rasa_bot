...
class LinearSVCClassifier(IntentClassifier, GraphComponent):
    ...
    def process(self, messages: List[Message]) -> List[Message]:
        ...
        for idx, message in enumerate(messages):
            ...
            message.set("intent", {"name": probas[idx], "confidence": 1}, add_to_output=True)
            message.set("intent_ranking", [{"name": probas[idx], "confidence": 1}], add_to_output=True)
        return messages
